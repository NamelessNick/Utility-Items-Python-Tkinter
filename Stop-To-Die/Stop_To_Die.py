...
class Upgrade_Button():
    def __init__(self, x, y, image_group, value):
        self.value = value
        self.image = image_group[value]
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.ground_surf = pygame.transform.scale(self.ground_surf, (6000,3000))
        self.ground_rect = self.ground_surf.get_rect(topleft=(-2000 , -1000))
    ...
    def custom_draw(self,player):
        ...
        self.internal_surf.fill('#212121')
...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos ,group,image_lists):
        ...
        self.left_look_block = False
        self.right_look_block = True
        self.speed = 7
    ...
    def frame_change(self,bullet_spawn_timer):
        ...
        if self.looking == 1:
            self.image_selected = pygame.transform.flip(self.image_selected, True, False)
            self.looking = 1
        elif self.looking == 2:
            self.looking = 0
...
class Enemy_type_2(pygame.sprite.Sprite):
    ...
    def update(self,player,x,y):
        ...
        if self.HP >= 0:
            self.frame_change()
            # locate player
            self.distance = math.sqrt((self.pos.x - player.rect.x)**2 + (self.pos.y - player.rect.y)**2)
            if self.distance > 750:
                angle_radians = (math.atan2(self.pos.y - player.pos.y, self.pos.x - player.pos.x))
                self.pos.y -= math.sin(angle_radians) * self.speed
                self.pos.x -= math.cos(angle_radians) * self.speed
            elif self.distance < 700:
                angle_radians = (math.atan2(self.pos.y - player.pos.y, self.pos.x - player.pos.x))
                self.pos.y += math.sin(angle_radians) * self.speed
                self.pos.x += math.cos(angle_radians) * self.speed
            else:
                # fire
                if self.sould_fire < 50:
                    self.sould_fire += 1
                else:
                    self.sould_fire = 0
                    pygame.event.post(pygame.event.Event(spawn_enemy2_bullet,message = self.pos))
        else:
            self.death_animation()
...
class Enemy_type_2_bullet(pygame.sprite.Sprite):
    def __init__(self, group, start_x, start_y, dest_x, dest_y, images):
        super().__init__(group)
        self.selected_list = images
        self.image_selected = images[0]
        self.rect = self.image_selected.get_rect()
        ...
        # Because rect.x and rect.y are automatically converted
        # to integers, we need to create different variablesthat
        # store the location as floating point numbers. Integers
        # are not accurate enough for aiming.
        self.floating_point_x = start_x
        self.floating_point_y = start_y
...
class Game_loop():
    def __init__(self):
        ...
        self.all_enemies_2 = pygame.sprite.Group()
    ...
    def upgrade_init(self):
        #Assign The upgrades values depending on their position on the list
        self.upgrade_bnt_1_value = random.randint(0,2)
        self.upgrade_bnt_1 = Upgrade_Button(650, 500, self.images_all_upgrades, self.upgrade_bnt_1_value)

        self.upgrade_bnt_2_value = random.randint(0,2)
        self.upgrade_bnt_2 = Upgrade_Button(900, 500, self.images_all_upgrades, self.upgrade_bnt_2_value)

        self.upgrade_bnt_3_value = random.randint(0,2)
        self.upgrade_bnt_3 = Upgrade_Button(1150, 500, self.images_all_upgrades, self.upgrade_bnt_3_value)

        self.all_upgrade_bnts = [self.upgrade_bnt_1, self.upgrade_bnt_2, self.upgrade_bnt_3]
    def updates(self):
        ...
        self.update_hp_bar()
        self.update_exp_bar()
        self.screen.blit(self.exp_png, (600, 100))
        ...
        self.all_enemy_projectiles.update(self.Player)
    ...
    def images(self):
        ...
        self.exp_bar_BG = pygame.transform.scale(self.exp_bar_BG, (450,90))
        ...
        self.image_Upgrade_Damage= pygame.image.load("Sprites/Upgrades/Upgrade_Damage.png").convert_alpha()
        self.image_Upgrade_Damage = pygame.transform.scale(self.image_Upgrade_Damage, (120, 130))

        self.image_Upgrade_Max_HP = pygame.image.load("Sprites/Upgrades/Upgrade_Max_HP.png").convert_alpha()
        self.image_Upgrade_Max_HP = pygame.transform.scale(self.image_Upgrade_Max_HP, (120, 130))

        self.image_Upgrade_Attack_Speed= pygame.image.load("Sprites/Upgrades/Upgrade_Attack_Speed.png").convert_alpha()
        self.image_Upgrade_Attack_Speed = pygame.transform.scale(self.image_Upgrade_Attack_Speed, (120, 130))


        self.images_all_upgrades = [self.image_Upgrade_Max_HP, self.image_Upgrade_Attack_Speed , self.image_Upgrade_Damage]
        ...
        self.image_Enemy1_walking_F1 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Walking/Enemy_1_walking_F1.png").convert_alpha()
        ...
        self.image_Enemy1_walking_F2 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Walking/Enemy_1_walking_F2.png").convert_alpha()
        ...
        self.image_Enemy1_walking_F3 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Walking/Enemy_1_walking_F3.png").convert_alpha()
        ...
        self.image_Enemy1_walking_F4 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Walking/Enemy_1_walking_F4.png").convert_alpha()
        ...
        self.image_Enemy1_walking_F5 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Walking/Enemy_1_walking_F5.png").convert_alpha()
        ...
        self.images_Enemy1_walking = [self.image_Enemy1_walking_F1,self.image_Enemy1_walking_F2,self.image_Enemy1_walking_F3,
                ...
                #hurt
        self.image_Enemy1_hurt_F1 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Hurt/Enemy_1_hurt_F1.png").convert_alpha()
        self.image_Enemy1_hurt_F1 = pygame.transform.scale(self.image_Enemy1_hurt_F1, (120, 130))

        self.image_Enemy1_hurt_F2 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Hurt/Enemy_1_hurt_F2.png").convert_alpha()
        ...
        self.image_Enemy1_crumble_F1 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Death/Enemy_1_Crumble_F1.png").convert_alpha()
        ...
        self.image_Enemy1_crumble_F2 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Death/Enemy_1_Crumble_F2.png").convert_alpha()
        ...
        self.image_Enemy1_crumble_F3 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Death/Enemy_1_Crumble_F3.png").convert_alpha()
        ...
        self.image_Enemy1_crumble_F4 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Death/Enemy_1_Crumble_F4.png").convert_alpha()
        ...
        self.image_Enemy1_crumble_F5 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Death/Enemy_1_Crumble_F5.png").convert_alpha()
        ...
        self.image_Enemy1_crumble_F6 = pygame.image.load(
            "Sprites/Enemies/Enemy_1/Death/Enemy_1_Crumble_F6.png").convert_alpha()
        ...
        self.images_Enemy1_all_lists = [self.images_Enemy1_walking,self.images_Enemy1_hurt,self.images_Enemy1_crumble]
            ...
            #Enemy 2
        #walking
        self.image_Enemy2_walking_F1 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Walking/Enemy_2_walking_F1.png").convert_alpha()
        self.image_Enemy2_walking_F1 = pygame.transform.scale(self.image_Enemy2_walking_F1, (192, 192))

        self.image_Enemy2_walking_F2 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Walking/Enemy_2_walking_F2.png").convert_alpha()
        self.image_Enemy2_walking_F2 = pygame.transform.scale(self.image_Enemy2_walking_F2,(192, 192))

        self.image_Enemy2_walking_F3 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Walking/Enemy_2_walking_F3.png").convert_alpha()
        self.image_Enemy2_walking_F3 = pygame.transform.scale(self.image_Enemy2_walking_F3, (192, 192))

        self.image_Enemy2_walking_F4 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Walking/Enemy_2_walking_F4.png").convert_alpha()
        self.image_Enemy2_walking_F4 = pygame.transform.scale(self.image_Enemy2_walking_F4, (192, 192))

        self.images_Enemy2_walking = [self.image_Enemy2_walking_F1,self.image_Enemy2_walking_F2,self.image_Enemy2_walking_F3,
                                   self.image_Enemy2_walking_F4]

        #hurt
        self.image_Enemy2_hurt_F1 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Hurt/Enemy_2_hurt_F1.png").convert_alpha()
        self.image_Enemy2_hurt_F1 = pygame.transform.scale(self.image_Enemy2_hurt_F1, (192, 192))

        self.image_Enemy2_hurt_F2 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Hurt/Enemy_2_hurt_F2.png").convert_alpha()
        self.image_Enemy2_hurt_F2 = pygame.transform.scale(self.image_Enemy2_hurt_F2, (192, 192))

        self.images_Enemy2_hurt = [self.image_Enemy2_hurt_F1,self.image_Enemy2_hurt_F2]


        self.image_Enemy2_deathF1 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Death/Enemy_2_death_F1.png").convert_alpha()
        self.image_Enemy2_deathF1 = pygame.transform.scale(self.image_Enemy2_deathF1 , (192, 192))

        self.image_Enemy2_deathF2 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Death/Enemy_2_death_F2.png").convert_alpha()
        self.image_Enemy2_deathF2 = pygame.transform.scale(self.image_Enemy2_deathF2, (192, 192))

        self.image_Enemy2_deathF3 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Death/Enemy_2_death_F3.png").convert_alpha()
        self.image_Enemy2_deathF3 = pygame.transform.scale(self.image_Enemy2_deathF3, (192, 192))

        self.image_Enemy2_deathF4 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Death/Enemy_2_death_F4.png").convert_alpha()
        self.image_Enemy2_deathF4 = pygame.transform.scale(self.image_Enemy2_deathF4, (192, 192))

        self.image_Enemy2_deathF5 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Death/Enemy_2_death_F5.png").convert_alpha()
        self.image_Enemy2_deathF5 = pygame.transform.scale(self.image_Enemy2_deathF5, (192, 192))

        self.image_Enemy2_deathF6 = pygame.image.load(
            "Sprites/Enemies/Enemy_2/Death/Enemy_2_death_F6.png").convert_alpha()
        self.image_Enemy2_deathF6 = pygame.transform.scale(self.image_Enemy2_deathF6, (192, 192))

        self.images_Enemy2_death = [self.image_Enemy2_deathF1,self.image_Enemy2_deathF2,self.image_Enemy2_deathF3,
                                      self.image_Enemy2_deathF4,self.image_Enemy2_deathF5,self.image_Enemy2_deathF6]

        self.images_Enemy2_all_lists = [self.images_Enemy2_walking, self.images_Enemy2_hurt,
                                        self.images_Enemy2_death]
    ...
    def update_hp_bar(self):
        ...
        self.HpRect.center = (160,145)
        self.health_FG = pygame.draw.rect(self.screen, (53, 13, 36),pygame.Rect(82, 128, 153 * self.HP_ratio, 36))
        self.screen.blit(self.health_BG, (0, 75))
    def update_exp_bar(self):
        self.Exp_ratio = self.level_up_progress / self.level_up_max
        self.Exp_FG = pygame.draw.rect(self.screen, (53, 13, 36),pygame.Rect(81, 90, 310* self.Exp_ratio, 33))
        self.screen.blit(self.exp_bar_BG, (5, 45))
        if self.level_up_progress >= self.level_up_max:
            self.level_up = True
            self.level_up_init = True
            self.level_up_progress = 0
        ...
        if self.Player.direction.x != 0 or self.Player.direction.y != 0:
            if self.spawn_bullet_cr == True:
                if self.spawn_bullet_timer < 800:
                    self.spawn_bullet_timer += self.Player.attack_speed
        ...
        while done == True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    self.enemy_choice = random.randint(1,2)
                    self.enemy_choice = 2
                    if self.enemy_choice == 1:
                        self.Enemy = Enemy_type_1(self.camera_group, self.images_Enemy1_all_lists)
                    elif self.enemy_choice == 2:
                        self.Enemy = Enemy_type_2(self.camera_group, self.images_Enemy2_all_lists)
                        self.all_enemies_2.add(self.Enemy)
                    self.Enemy.spawn(self.Player)
                    self.all_enemies.add(self.Enemy)


                elif event.type == spawn_enemy2_bullet:
                    len0 = len(self.all_enemies_2.sprites())
                    stx = self.all_enemies_2.sprites()[random.randint(0, len0 - 1)].pos.x
                    sty = self.all_enemies_2.sprites()[random.randint(0, len0 - 1)].pos.y
                    self.Bullet_E2 = Enemy_type_2_bullet(self.camera_group,stx,sty,self.Player.pos.x,self.Player.pos.y,self.images_Projectile1_moving)


                    self.all_enemy_projectiles.add(self.Bullet_E2)
